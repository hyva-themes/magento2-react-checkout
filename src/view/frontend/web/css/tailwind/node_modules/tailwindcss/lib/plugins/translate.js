...
function _default() {
  return function ({
    ...
    if (config('mode') === 'jit') {
      return (0, _createUtilityPlugin.default)('translate', [[['translate-x', ['--tw-translate-x', ['transform', 'var(--tw-transform)']]], ['translate-y', ['--tw-translate-y', ['transform', 'var(--tw-transform)']]]]])({
        config,
        ...rest
      });
    } else {
